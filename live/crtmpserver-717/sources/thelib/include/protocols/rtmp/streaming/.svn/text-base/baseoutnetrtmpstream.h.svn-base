...
private:
	...
	// Added by Tady, 07122012.
	bool AllowExecution2(uint32_t totalProcessed, uint32_t dataLength, bool isAudio, uint32_t frameLevel);
	uint32_t CalcFrameLevel(uint8_t *pData, uint32_t length, bool isAudio);
};
