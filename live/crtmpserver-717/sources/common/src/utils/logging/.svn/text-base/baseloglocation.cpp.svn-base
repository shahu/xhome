...
bool BaseLogLocation::Init() {
	...
	if (_configuration.HasKeyChain(V_BOOL, false, 1, CONF_LOG_APPENDER_SOURCE_INFO))
                _sourceInfo = (bool) _configuration.GetValue(CONF_LOG_APPENDER_SOURCE_INFO, false);
	return true;
}
