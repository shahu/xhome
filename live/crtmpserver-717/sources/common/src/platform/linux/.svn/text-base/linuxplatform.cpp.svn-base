...
void installUSR1Signal(SignalFnc pConfRereadSignalFnc) {
	installSignal(SIGUSR1, pConfRereadSignalFnc);
}
void installUSR2Signal(SignalFnc pConfRereadSignalFnc) {
	installSignal(SIGUSR2, pConfRereadSignalFnc);
}
#endif /* LINUX */
